...
import { Api, KendraIndex, S3BucketWithDocs, BedrockKnowledgeBase } from './constructs';
...
export class RagAvatarStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const ragType: string =
      this.node.tryGetContext('ragType') || 'kendra';
    ...
    if (ragType === 'kendra') {
      ...
      throw new Error(`Invalid ragType: ${ragType}. Must be 'kendra' or 'knowledgebase'`);
    }
